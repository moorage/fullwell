...
- prepared client `1.1.1` to expose the branded `fullwell@fullwell` selector for Codex and Claude, use the real `moorage/fullwell` marketplace source, and retain the npm package and hosted MCP identity unchanged

...
- The public immutable `@fullwell/fullwell@1.1.20` registry artifact matches the prepared integrity and clean download, passes Codex and Claude lifecycle checks, distinguishes the unchanged `fullwell-local` MCP from the hosted `fullwell-cloud` MCP, and makes recovered-cloud journal updates atomic.

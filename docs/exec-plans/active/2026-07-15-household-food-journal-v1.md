...
- [x] 2026-07-16T18:23Z: Added a fail-closed direct-Neon migration runner, applied schema `0005` with idempotent re-entry on a one-day schema-only Neon branch, and passed all nine managed-Neon adapter tests; PITR/snapshot recovery remains open.

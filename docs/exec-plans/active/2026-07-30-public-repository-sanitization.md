...
- [ ] Milestone 2: Rotate and validate the production WhatsApp webhook verification token.
- [ ] Milestone 3: Sanitize the current tree, add a future sensitive-content gate, and detach private Beads data from the public Git remote.
- [ ] Milestone 4: Build and validate a rewritten history in an isolated mirror.
- [ ] Milestone 5: Apply the verified rewrite to local `main` and GitHub, remove custom refs, and re-audit a fresh clone.
- [ ] Milestone 6: Complete documentation, quality gates, Beads closure, and recovery handoff.

...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `now` | `promoted` | `high` | `high` | `medium` | Durable images from computer-use collection | Makes every grocery, recipe, and delivery item learned through an authorized browser traversal retain the exact public image and page provenance that the cloud and visual journal need. | [brief](../../docs/ideas/backlog/durable-computer-use-images.md), [completed ExecPlan](../../docs/exec-plans/completed/2026-07-27-durable-computer-use-images.md) |

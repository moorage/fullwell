...
- Unit/application tests pass: 59 tests with four Neon tests skipped when no database URL is supplied.
...
- `npm run test:coverage` reports 67.55% line coverage against the enforced 90% threshold.

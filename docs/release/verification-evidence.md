...
- Deterministic unit, component, application, and load coverage passes the enforced repository gate: 187 tests pass at 97.06% statements/lines, 95.07% functions, and 90.29% branches; nine Neon integration tests skip when no database URL is supplied.

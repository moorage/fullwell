...
- Deterministic unit, component, and application coverage passes the enforced repository gate: 169 tests pass at 96.85% statements/lines, 94.89% functions, and 90.09% branches; nine Neon integration tests skip when no database URL is supplied.
...
- Encrypted off-site backup with persisted fsck/signature/restore-drill evidence and full accessibility/security/load suites are incomplete.
